    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(choices=[('text/plain', 'Plain'), ('text/markdown', 'Markdown'), ('image/png;base64', 'PNG Image'), ('image/jpeg;base64', 'JPEG Image'), ('image/gif;base64', 'GIF Image')], default='text/plain', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(blank=True, default='text/plain', max_length=50, null=True)),
