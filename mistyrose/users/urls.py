...
urlpatterns = [
    ...
    path('api/authors/<path:pk>/profile/', AuthorProfileView.as_view(), name='author-profile'),  # Author profile view
    path('api/authors/<path:pk>/profile/edit/', AuthorEditProfileView.as_view(), name='author-edit-profile'),  # Edit author profile
    path('authors/<str:username>/upload_image/', ProfileImageUploadView.as_view(), name='upload-profile-image'),
    path('api/authors/<path:pk>/followers/', FollowersDetailView.as_view(), name='author-followers'),  # Followers endpoint
    path('api/authors/<path:pk>/friends/', FriendsView.as_view(), name='author-friends'),  # Friends endpoint
    path('api/authors/<path:pk>/following/', FollowingDetailView.as_view(), name='author-following'),  # Friends endpoint
]