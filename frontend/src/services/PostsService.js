...
export const getPost = async (authorSerial, postSerial) => {
    try {
        const response = await api.get(`/authors/${authorSerial}/posts/${postSerial}`);
...
export const deletePost = async (authorSerial, postSerial) => {
    try {
        const response = await api.delete(`/authors/${authorSerial}/posts/${postSerial}`);
        return response.data;
    } catch (error) {
        console.error(error);
    }
...
export const updatePost = async (authorSerial, postSerial, postData) => {
    try {
        const response = await api.put(`/authors/${authorSerial}/posts/${postSerial}`, postData);
        return response.data;
    } catch (error) {
        console.error(error);
    }
...
export const getPostImage = async (authorSerial, postSerial) => {
    try {
        const response = await api.get(`/authors/${authorSerial}/posts/${postSerial}/image`);
        return response.data;
    } catch (error) {
        console.error(error);
    }
